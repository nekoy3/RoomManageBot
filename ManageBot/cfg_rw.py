...
def create_config():
    ...
    config['CHAT'] = {'first_channel_id': '', 'second_channel_id': '', 'first_channel_webhook': 'https://discord.com/api/webhooks/000000000000000000/webhooktokenheresushi', 'second_channel_webhook': 'https://discord.com/api/webhooks/000000000000000000/webhooktokenheresushi'}
...
def main():
    ...
    try:
        ...
        configClass.webhooks = [config['CHAT']['first_channel_webhook'], config['CHAT']['second_channel_webhook']]
