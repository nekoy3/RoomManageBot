...
def create_config():
    ...
    config['CHANNEL'] = {'first_channel_id': '', 'second_channel_id': '', 'first_channel_webhook': 'https://discord.com/api/webhooks/00000000000000/token', 'second_channel_webhook': 'https://discord.com/api/webhooks/00000000000000/token'}
    config['TOKEN'] = {'token': ''}
